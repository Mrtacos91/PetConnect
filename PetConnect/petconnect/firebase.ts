...
export const VAPID_KEY = "BHcoQ51F4626heoEPCv6m2ofkWAbqOGxb-90DO_9ljj7A__8kC22n42GngzidG50oAv68IhHqPS_4iyMrVmWny0";
...
export const sendPushNotificationToServer = async (
  ...
  // En un caso real, deberías tener un endpoint en tu backend que reciba estos datos
  // y use Firebase Admin SDK para enviar la notificación.
  
  try {
    // Esta URL debe ser reemplazada por tu endpoint real
    const serverUrl = "/api/notifications/send";
...
export const getOrCreateFCMToken = async (vapidKey: string = VAPID_KEY): Promise<string | null> => {
  try {
